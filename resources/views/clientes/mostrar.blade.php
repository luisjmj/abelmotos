...
@section("contenido")
            ...
            <div class="column">
                <div class="notification">
                    <div class="columns is-vcentered">
                        <div class="column">
                            @verbatim
                                <h4 class="is-size-4">Clientes ({{paginacion.total}})</h4>
                            @endverbatim
                        </div>
                        <div class="column">
                        ...
                        <div class="column">
                            <div class="field is-grouped is-pulled-right">
                                <div class="control">
                                    <a href="{{route("formularioAgregarCliente")}}" class="button is-success">Agregar</a>
                                </div>
                                <div class="control">
                                    @verbatim
                ...
                <transition name="fade">
                    <div v-show="clientes.length <= 0 && !busqueda && !cargando.lista"
                         class="notification is-info has-text-centered">
                        <h3 class="is-size-3">Todavía no hay clientes</h3>
                        <div>
                            <h1 class="icono-gigante">
                ...
                <div>
                    <table v-show="clientes.length > 0 && !cargando.lista"
                        ...
                        @verbatim
                            <tr v-for="cliente in clientes">
                                <td>
                                    <button @click="invertirEstado(cliente)" class="button"
                                            :class="{'is-info': cliente.marcado}">
                                    <span class="icon is-small">
                                        <i class="fa fa-check"></i>
                                    </span>
                                    </button>
                                ...
                                <td>{{cliente.email}}</td>
                                <td>
                                    <button @click="editar(cliente)" class="button is-warning">
                                    <span class="icon is-small">
                                ...
                                <td>
                                    <button @click="eliminar(cliente)" class="button is-danger"
                                            :class="{'is-loading': cliente.eliminando}">
                                    <span class="icon is-small">
    ...
    <script src="{{url("/js/clientes/mostrar.js?q=") . time()}}"></script>
@endsection
