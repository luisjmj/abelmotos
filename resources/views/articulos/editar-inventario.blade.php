    ...
    <div class="container">
        <div class="columns">
            <div class="column is-half-tablet">
                <h1 class="is-size-1">Editar Inventario</h1>
                <form method="POST" action="{{route("editarInventarioPost",[$inventario])}}">
                    @csrf
                    <div class="field">
                        <label class="label">Fecha de adquisición</label>
                        <div class="control">
                            <input name="fecha_de_adquisicion" autocomplete="off" class="input" type="date" value="{{$inventario->fecha_adquisicion->format('Y-m-d')}}">
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input name="costo_de_adquisicion" autocomplete="off" class="input" type="text"
                                   placeholder="Costo de adquisicion" value="{{$inventario->precio_adquisicion}}">
                        </div>
                    </div>
                    <div class="field">
