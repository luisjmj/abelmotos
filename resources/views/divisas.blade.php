...
@section("contenido")
            ...
            <div class="column">
                <div class="notification">
                    <div class="columns is-vcentered">
                        <div class="column">
                            @verbatim
                                <h4 class="is-size-4">Divisa ({{paginacion.total}})</h4>
                            @endverbatim
                        </div>
                        <div class="column">
                        ...
                        <div class="column">
                            <div class="field is-grouped is-pulled-right">
                                <div class="control">
                                    <a href="{{route("formularioDivisa")}}" class="button is-success">Agregar</a>
                                </div>
                                <div class="control">
                                    @verbatim
                ...
                <transition name="fade">
                    <div v-show="divisas.length <= 0 && !busqueda && !cargando.lista"
                         class="notification is-info has-text-centered">
                        <h3 class="is-size-3">No hay divisas</h3>
                        <div>
                            <h1 class="icono-gigante">
                        ...
                        <p class="is-size-5">
                            Parece que no has agregado ninguna divisa. Registra una haciendo click en el botón
                ...
                <div>
                    ...
                    <table v-show="divisas.length > 0 && !cargando.lista"
                        ...
                        @verbatim
                            <tr v-for="divisa in divisas">
                                <td>
                                    <button @click="invertirEstado(divisa)" class="button"
                                            :class="{'is-info': divisa.marcada}">
                                    <span class="icon is-small">
                                        <i class="fa fa-check"></i>
                                    </span>
                                    </button>
                                ...
                                <td>{{divisa.tasa}}</td>
                                <td>
                                    <button @click="editar(divisa)" class="button is-warning">
                                    <span class="icon is-small">
                                ...
                                <td>
                                    <button @click="eliminar(divisa)" class="button is-danger"
                                            :class="{'is-loading': divisa.eliminando}">
                                    <span class="icon is-small">
    ...
    <script src="{{url("/js/divisas.js?q=") . time()}}"></script>
@endsection
